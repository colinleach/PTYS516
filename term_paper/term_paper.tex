...
The coring sampler (C-SMP) is intended to penetrate the regolith to take material from >2 cm depth. The pneumatic sampler (P-SMP) then uses N\tsub{2} gas to fire surface material into a sample container. Each sample will be sealed and stored separately in the sample return module. Some sampler design ideas are discussed in \citet{kawakatsu_preliminary_2022} but this key component of the mission is still evolving as of early 2022.
